                ...
                <section class="content-header">
                    <div class="user-statistic-week">     
                        <div class="top-s-header col-md-6"> 
                            <h3>Nhập tiền thưởng hàng tháng</h3>
                        </div>
                    </div> 
                </section>
                <!-- Main content -->
                <section class="content">
                    <div class="col-md-10">
                        <div class="box box-info ">
                            ...
                            <div class="box-body">
                                <form:form method="POST" action="/addMoneybonus" cssClass="form form-horizontal" >
                                    <div class="form-group">
                                        <label class="col-md-2">Tên tiền thưởng: </label>
                                        <div class="col-md-10">
                                            <form:input path="nameBonus" cssClass="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <form:select path="uid" items="${name1}" cssClass="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2">Ngày Tháng: </label>
                                        <div class="col-md-10">
